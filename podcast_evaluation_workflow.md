...
| **[軌道 B] 複審決選**<br>(各獎項 Top 3 診斷) | **Gemini 1.5 Pro API 聲音特徵與片段提取**<br>針對各獎項 **Top 3 入圍節目**（約 15-20 檔），**每檔評估 3 集**（共 45-60 集音檔）進行音質、默契診斷與每集各 3 段黃金時間軸提取。 | **8 ~ 12 分鐘**<br>(並行處理) | **約 NT$ 430 ~ 580 元**<br>(按音訊分鐘計費) | **0%**<br>(雲端運算) |
